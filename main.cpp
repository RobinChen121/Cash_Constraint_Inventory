 ...
 * Description: 4 periods, capacity 40, running time is 0.61s, while java is 4s; after using
 * Theorem 2, time is 0.33s; Only computing a* is very fast. For 30 periods, the running time is
 * less than 0.00001s. 6 periods, capacity 30, running time is 32.59s; running time when using a*
 * is 23.25s;
 * parameters:
...
int main() {
    ...
    constexpr double ini_I1 = 0;
    constexpr double ini_I2 = 0;
    constexpr double truncated_quantile = 0.999;
    constexpr int capacity = 30;
    constexpr double max_I = 100;
    ...
    std::cout << "optimal cash balance is " << std::fixed << std::setprecision(6) << result[0]
              << std::endl;
    ...
    std::cout << "optimal cash balance using Theorem2 is " << std::fixed << std::setprecision(6)
              << value2 << std::endl;
    ...
    std::cout << "cash balance using heuristic1 is " << std::fixed << std::setprecision(6) << value3
              << std::endl;
    ...
    problem.set_pmfs(mean_demands, scales, truncated_quantile);
    problem.get_a_stars();
    const double value4 = problem.heuristic1_2(ini_state);
    ...
    std::cout << "cash balance using heuristic1 is " << std::fixed << std::setprecision(6) << value4
              << std::endl;
    ...
    std::cout << "cash balance using heuristic2 is " << std::fixed << std::setprecision(6) << value5
              << std::endl;
